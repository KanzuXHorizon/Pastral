...
- [ ] **Step 3: Implement bounded value types and UTF-8 truncation**
...
- [ ] **Step 6: Run GREEN and storage regression**
...
- [ ] **Step 2: Add failing authenticated read tests**
...
- [ ] **Step 4: Add `ServeRead` parsing and usage**
...
- [ ] **Step 5: Generalize one-request serving**
